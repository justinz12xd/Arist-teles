...
const PARTNERS = ["NOVA LABS", "HELIO CLOUD", "VECTOR VC", "KUIPER DEV", "ANDRÓMEDA", "PULSAR AI"];

export function Partners() {
  return (
    <section id="partners" className="relative mx-auto max-w-6xl scroll-mt-[var(--header-h)] px-6 py-32">
      <ScrollReveal>
        <SectionLabel>[ 06 · aliados ]</SectionLabel>
        <h2 className="text-h2 max-w-2xl">Estaciones amigas.</h2>
      </ScrollReveal>
