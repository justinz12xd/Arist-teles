    ...
    <footer className="border-t border-[var(--primary-4)] px-6 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex items-center gap-2 text-white">
          ...
          <span className="font-medium">ARISTÓTELES</span>
          <span className="section-label ml-3">liceo digital · evidencia y dictamen</span>
        </div>

        <nav className="flex gap-6 text-sm text-[var(--primary-44)]">
          <a href="#about" className="transition-colors hover:text-white">Misión</a>
          <a href="#timeline" className="transition-colors hover:text-white">Flujo</a>
        ...
        <div className="flex gap-5 font-mono text-xs tracking-widest text-[var(--primary-44)]">
          ...
          <a href="#" className="transition-colors hover:text-[var(--accent-cyan)]">DEMO</a>
          <a href="#" className="transition-colors hover:text-[var(--accent-cyan)]">PDF</a>
        </div>
      </div>
      <p className="mt-10 text-center text-xs text-[var(--primary-44)]">
        © 2026 Aristóteles. Liceo digital para deliberar con evidencia. El juicio final sigue siendo humano.
      </p>
    </footer>
  );
}
