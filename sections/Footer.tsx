    ...
    <footer className="border-t border-[var(--primary-4)] px-6 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex items-center gap-2 text-white">
          ...
          <span className="section-label ml-3">decisión respaldada por evidencia</span>
        </div>
      ...
      <p className="mt-10 text-center text-xs text-[var(--primary-44)]">
        © 2026 Aristóteles. Sistema de apoyo a decisiones, no sustituto de criterio profesional.
      </p>
    </footer>
  );
}
